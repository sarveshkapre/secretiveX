...
- [ ] Have `secretive-bench` report both the auto-selected queue-wait thresholds and actual measured percentiles in its JSON so dashboards can track guardrail drift without parsing shell output.
