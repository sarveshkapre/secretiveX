...
extension JustUpdatedChecker {
    ...
    enum Constants {
        static let previousVersionUserDefaultsKey = "com.sarveshkapre.Secretive.lastBuild"
        static let previousOSVersionUserDefaultsKey = "com.sarveshkapre.Secretive.lastOS"
    }
