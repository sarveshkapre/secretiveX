...
@Observable public final class Updater: UpdaterProtocol, Sendable {
    ...
    public func checkForUpdates() async throws {
        let session = try await XPCTypedSession<[Release], Never>(serviceName: "com.sarveshkapre.Secretive.SecretiveUpdater")
...
extension Updater {
    ...
    var defaults: UserDefaults {
        UserDefaults(suiteName: "com.sarveshkapre.Secretive.updater.ignorelist")!
    }
