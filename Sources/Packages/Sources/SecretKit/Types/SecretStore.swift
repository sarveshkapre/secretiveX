...
extension NSNotification.Name {
    ...
    public static let secretStoreUpdated = NSNotification.Name("com.sarveshkapre.Secretive.secretStore.updated")
    // Internal notification that keys were reloaded from the backing store.
    public static let secretStoreReloaded = NSNotification.Name("com.sarveshkapre.Secretive.secretStore.reloaded")
