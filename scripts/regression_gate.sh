...
REGRESSION_SLO_CONCURRENCY="${REGRESSION_SLO_CONCURRENCY:-256}"
REGRESSION_SLO_DURATION_SECS="${REGRESSION_SLO_DURATION_SECS:-8}"
REGRESSION_SLO_MIN_RPS="${REGRESSION_SLO_MIN_RPS:-10}"
REGRESSION_SLO_MAX_P95_US="${REGRESSION_SLO_MAX_P95_US:-500000}"
