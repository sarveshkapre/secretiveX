...
REGRESSION_DURATION_SMOKE_CONCURRENCY="${REGRESSION_DURATION_SMOKE_CONCURRENCY:-256}"
REGRESSION_DURATION_SMOKE_DURATION_SECS="${REGRESSION_DURATION_SMOKE_DURATION_SECS:-4}"
REGRESSION_DURATION_SMOKE_MIN_RPS="${REGRESSION_DURATION_SMOKE_MIN_RPS:-5}"
REGRESSION_DURATION_SMOKE_MAX_FAILURE_RATE="${REGRESSION_DURATION_SMOKE_MAX_FAILURE_RATE:-0.2}"
...
echo "[regression] Duration reconnect smoke gate"
DURATION_SMOKE_CONCURRENCY="$REGRESSION_DURATION_SMOKE_CONCURRENCY" \
DURATION_SMOKE_DURATION_SECS="$REGRESSION_DURATION_SMOKE_DURATION_SECS" \
DURATION_SMOKE_MIN_RPS="$REGRESSION_DURATION_SMOKE_MIN_RPS" \
DURATION_SMOKE_MAX_FAILURE_RATE="$REGRESSION_DURATION_SMOKE_MAX_FAILURE_RATE" \
